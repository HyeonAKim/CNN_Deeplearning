...
top_model_weights_dir = '..\\CNN_Deeplearning\\Models\\Bearing_ResNet50\\model\\top_model'
pathlib.Path(top_model_weights_dir).mkdir(parents=True, exist_ok=True)
top_model_weights_path = os.path.join(top_model_weights_dir,'resnet_fc_model.h5')


train_feature_save_dir = '..\\CNN_Deeplearning\\Models\\Bearing_ResNet50\\model\\feature'
pathlib.Path(train_feature_save_dir).mkdir(parents=True, exist_ok=True)
train_feature_save_path = os.path.join(train_feature_save_dir,'resnet50_feature_train.npy')

test_feature_save_dir = '..\\CNN_Deeplearning\\Models\\Bearing_ResNet50\\model\\feature'
pathlib.Path(test_feature_save_dir).mkdir(parents=True, exist_ok=True)
test_feature_save_path = os.path.join(test_feature_save_dir,'bottleneck_features_test.npy')
...
def train_top_model():
    ...
    test_data = np.load(open(test_feature_save_path, 'rb'))
